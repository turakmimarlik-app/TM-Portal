                        ...
                        <div class="card-main-header" style="display:flex; justify-content:space-between; align-items:center;">
                            ...
                            <div style="display:flex; align-items:center; gap:12px;">
                                <div style="display:flex; flex-direction:column; gap:5px;">
                                    <div style="display:flex; align-items:center; gap:6px;"><span style="font-size:12px; color:var(--btn-green); font-weight:700; white-space:nowrap;">Tahsilat</span><div style="flex:1; height:14px; background:var(--bg-main); border-radius:6px; overflow:hidden; box-shadow:inset 0 1px 3px rgba(0,0,0,0.15); min-width:60px;"><div style="height:100%; width:${tahsilatYuzde}%; background:linear-gradient(90deg, var(--btn-green), #4caf50); border-radius:6px; transition:width 0.4s;"></div></div><span style="font-size:12px; color:var(--text-light); font-weight:700; white-space:nowrap; min-width:36px; text-align:right;">%${tahsilatYuzde}</span></div>
                                    <div style="display:flex; align-items:center; gap:6px;"><span style="font-size:12px; color:var(--accent-red); font-weight:700; white-space:nowrap;">Ödeme</span><div style="flex:1; height:14px; background:var(--bg-main); border-radius:6px; overflow:hidden; box-shadow:inset 0 1px 3px rgba(0,0,0,0.15); min-width:60px;"><div style="height:100%; width:${odemeYuzde}%; background:linear-gradient(90deg, var(--accent-red), #ff5722); border-radius:6px; transition:width 0.4s;"></div></div><span style="font-size:12px; color:var(--text-light); font-weight:700; white-space:nowrap; min-width:36px; text-align:right;">%${odemeYuzde}</span></div>
                                </div>
